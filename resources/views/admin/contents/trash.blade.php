			...
			<tbody class="w-full flex-1 sm:flex-none bg-white divide-y divide-gray-400 text-sm leading-5">
				...
				<tr class="flex flex-col lg:table-row even:bg-gray-200">
					...
					<td class="flex flex-row lg:table-cell">
						...
						<div class="p-2 text-center">
							<a href="{{ route('contents.restore', $content->id) }}" title="Restaurar" alt="Restaurar" class="px-3 py-2 font-semibold uppercase text-sm text-white bg-blue-600 hover:bg-blue-500 tracking-wider rounded-md transition">
