<x-dashboard-layout>
	...
	<div class="max-w-7xl mx-auto mb-14 mt-6 lg:mt-8 sm:px-6 lg:px-8">
		...
		<div class="my-3 flex justify-end">
			<a href="{{ route('settings.create') }}" title="Agregar" alt="Agregar" class="px-3 py-2 font-semibold uppercase text-sm text-white bg-green-600 hover:bg-green-500 tracking-wider rounded-md transition">
				<i class="fas fa-fw fa-plus-square"></i> Agregar Nuevo
			</a>
			<a href="{{ route('settings.trash') }}" title="Papelera" alt="Papelera" class="ml-2 px-3 py-2 font-semibold uppercase text-sm text-white bg-red-600 hover:bg-red-500 tracking-wider rounded-md transition">
          ...
          @foreach($settings as $setting)
            <tr class="flex flex-col lg:table-row even:bg-gray-200">
              ...
              <td class="flex flex-row lg:table-cell">
                ...
                <div class="p-2 text-center">
                  <a href="{{ route('settings.edit', $setting) }}" title="Editar" alt="Editar" class="px-3 py-2 font-semibold uppercase text-sm text-white bg-blue-600 hover:bg-blue-500 tracking-wider rounded-md transition">
